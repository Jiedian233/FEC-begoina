...
*/
static void element_init(element_t e, field_ptr f) {
  e->field = f;
  f->init(e);
}
...
lies in.
*/
static void element_init_same_as(element_t e, element_t e2) {
...
*/
static void element_clear(element_t e) {
  e->field->clear(e);
}
...
2 and 36.
*/
static size_t element_out_str(FILE * stream, int base, element_t e) {
...
*/
static  int element_snprint(char *s, size_t n, element_t e) {
  return e->field->snprint(s, n, e);
}

static void element_set_multiz(element_t e, multiz m) {
...
*/
static int element_set_str(element_t e, const char *s, int base) {
...
Set 'e' to 'i'.
*/
static void element_set_si(element_t e, signed long int i) {
  e->field->set_si(e, i);
}
...
Set 'e' to 'a'.
*/
static void element_set(element_t e, element_t a) {
  PBC_ASSERT_MATCH2(e, a);
  e->field->set(e, a);
}

static void element_add_ui(element_t n, element_t a,
                                  unsigned long int b) {
...
*/
static void element_to_mpz(mpz_t z, element_t e) {
  e->field->to_mpz(z, e);
}

static long element_to_si(element_t e) {
  mpz_t z;
  mpz_init(z);
  e->field->to_mpz(z, e);
...
Set 'n' to 'a' + 'b'.
*/
static void element_add(element_t n, element_t a, element_t b) {
...
Set 'n' to 'a' - 'b'.
*/
static void element_sub(element_t n, element_t a, element_t b) {
  PBC_ASSERT_MATCH3(n, a, b);
  n->field->sub(n, a, b);
}
...
Set 'n' = 'a' 'b'.
*/
static void element_mul(element_t n, element_t a, element_t b) {
  PBC_ASSERT_MATCH3(n, a, b);
  n->field->mul(n, a, b);
}
...
/*@manual earith
*/
static void element_mul_mpz(element_t n, element_t a, mpz_t z) {
...
*/
static void element_mul_si(element_t n, element_t a,
                                  signed long int z) {
  PBC_ASSERT_MATCH2(n, a);
...
*/
static void element_mul_zn(element_t c, element_t a, element_t z) {
  mpz_t z0;
...
Set 'n' = 'a' / 'b'.
*/
static void element_div(element_t n, element_t a, element_t b) {
  PBC_ASSERT_MATCH3(n, a, b);
  n->field->div(n, a, b);
}
...
Set 'n' = 'a' + 'a'.
*/
static void element_double(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->doub(n, a);
}
...
Set 'n' = 'a/2'
*/
static void element_halve(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->halve(n, a);
}
...
Set 'n' = 'a'^2^
*/
static void element_square(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->square(n, a);
}
...
*/
static void element_pow_mpz(element_t x, element_t a, mpz_t n) {
...
*/
static void element_pow_zn(element_t x, element_t a, element_t n) {
  mpz_t z;
  PBC_ASSERT_MATCH2(x, a);
  mpz_init(z);
  element_to_mpz(z, n);
...
Set 'n' = -'a'.
*/
static void element_neg(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->neg(n, a);
}
...
*/
static void element_invert(element_t n, element_t a) {
  PBC_ASSERT_MATCH2(n, a);
  n->field->invert(n, a);
}
...
*/
static int element_is1(element_t n) {
...
*/
static int element_is0(element_t n) {
...
zero otherwise.
*/
static int element_is_sqr(element_t a) {
  return a->field->is_sqr(a);
}

/*@manual ecmp
*/
static int element_sgn(element_t a) {
...
*/
static int element_sign(element_t a) {
  return a->field->sign(a);
}

static void element_sqrt(element_t a, element_t b) {
  PBC_ASSERT_MATCH2(a, b);
  a->field->sqrt(a, b);
}
...
*/
static int element_length_in_bytes(element_t e) {
...
*/
static int element_to_bytes(unsigned char *data, element_t e) {
...
*/
static int element_from_bytes(element_t e, unsigned char *data) {
...
*/
static void element_pow2_zn(element_t x, element_t a1, element_t n1,
...
*/
static void element_pow3_zn(element_t x, element_t a1, element_t n1,
                                   element_t a2, element_t n2,
...
in 'p'.
*/
static void element_pp_init(element_pp_t p, element_t in) {
  p->field = in->field;
...
*/
static void element_pp_clear(element_pp_t p) {
  p->field->pp_clear(p);
}
...
*/
static void element_pp_pow(element_t out, mpz_ptr power,
                                  element_pp_t p) {
...
*/
static void element_pp_pow_zn(element_t out, element_t power,
                                     element_pp_t p) {
  mpz_t z;
  mpz_init(z);
...
*/
static int element_item_count(element_t e) {
...
*/
static element_ptr element_item(element_t e, int i) {
...
static field_ptr element_item_field(element_t e) {
...
*/
static element_ptr element_x(element_ptr a) {
  return a->field->get_x(a);
}
/*@manual etrade
Equivalent to `element_item(a, 1)`.
*/
static element_ptr element_y(element_ptr a) {
